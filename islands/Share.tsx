    ...
    return (
        <div class={tw`fixed inset-0 m-4 flex flex-col`}>
            ...
            <section class={tw`flex flex-col w-full h-full my-auto justify-center items-center`}>
                <img draggable={false} onClick={() => open(`https://www.pokemon.com/us/pokedex/${data.name}`)} class={tw`pointer h-[350px] mb-6 animate-bounce`} src={data.sprites.other.home.front_default} />
